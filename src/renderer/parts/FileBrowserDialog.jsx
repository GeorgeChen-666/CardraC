...
export const FileBrowserDialog = forwardRef((props, ref) => {
  ...
  const [quickAccessPaths, setQuickAccessPaths] = useState([
    { id: 'desktop', name: '桌面', icon: '🖥️', path: 'C:/Users/Public/Desktop' },
    { id: 'documents', name: '文档', icon: '📄', path: 'C:/Users/Public/Documents' },
    { id: 'downloads', name: '下载', icon: '⬇️', path: 'C:/Users/Public/Downloads' },
    { id: 'pictures', name: '图片', icon: '🖼️', path: 'C:/Users/Public/Pictures' },
  ]);
