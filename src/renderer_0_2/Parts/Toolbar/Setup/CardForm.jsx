...
export const CardForm = () => {
  ...
  return (<div className={'FormPanel'}>
    <FormControl label={`${t('configDialog.cardWidth')} / ${t('configDialog.cardHeight')}`} width={'145px'} attrKey={'cardWidth'}
      ...
      <FormControl width={'145px'} attrKey={'cardHeight'} type={ControlType.NumberInput} min={-9999}>
        mm
      </FormControl>
    </FormControl>
    {
      ...
      (<FormControl label={`${t('configDialog.marginX')} / ${t('configDialog.marginY')}`} width={'145px'} attrKey={'marginX'}
                                       type={ControlType.NumberInput} min={-9999}>
        <FormControl width={'145px'} attrKey={'marginY'} type={ControlType.NumberInput} min={-9999}>
          mm
        </FormControl>
      </FormControl>)
    }
    ...
    <FormControl label={t('configDialog.bleed')} width={'145px'} attrKey={'bleedX'}
                 type={ControlType.NumberInput} min={-9999}>
      <FormControl width={'145px'} attrKey={'bleedY'} type={ControlType.NumberInput} min={-9999}>
        mm
      </FormControl>
    </FormControl>
    <FormControl label={t('configDialog.columns_rows')} width={'145px'} attrKey={'rows'}
                 type={ControlType.NumberInput} min={-9999}>
      <FormControl width={'145px'} attrKey={'columns'} type={ControlType.NumberInput} min={-9999}>
      </FormControl>
